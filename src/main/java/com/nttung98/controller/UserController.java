...
import com.nttung98.dto.AuthenticationUserDTO;
...
import com.nttung98.service.GroupUserJoinService;
...
public class UserController {
    ...
    public List<GroupMemberDTO> getAllUsersNotInGroup(@PathVariable String groupUrl) {
        int groupId = groupService.findGroupByUrl(groupUrl);
        RoleKey roleKey = new RoleKey();
        roleKey.setGroupId(groupId);
    ...
    public List<GroupMemberDTO> getAllUsers(@PathVariable String groupUrl) {
        List<GroupMemberDTO> toSend = new ArrayList<>();
        int id = groupService.findGroupByUrl(groupUrl);
        Optional<Group> optionalGroupEntity = groupService.findById(id);
    ...
    public ResponseEntity<GroupMemberDTO> addUserToConver(@PathVariable int userId, @PathVariable String groupUrl) {
        int groupId = groupService.findGroupByUrl(groupUrl);
        try {
