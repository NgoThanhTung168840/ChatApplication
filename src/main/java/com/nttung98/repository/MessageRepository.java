...
public interface MessageRepository extends JpaRepository<Message, Integer> {
    ...
    List<Message> findByGroupIdAndOffset(@Param(value = "id") int id, @Param(value = "offset") int offset);
    ...
    Message findLastMessageByGroupId(@Param(value = "idOfGroup") int groupId);
